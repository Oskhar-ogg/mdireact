          ...
          renderItem={({ item }) => (
            <Card>
              <Card.Title
                ...
                subtitle={item.bitacora_trabajo + ' || ' + item.bitacora_estado}
                left={LeftContent}
              />
              <Card.Title title={item.bitacora_title.toUpperCase()} /> 
              <Card.Content>
                <Text variant="bodyMedium" style={{ fontSize: 20 }}>
                  {item.bitacora_description}
                </Text>
              </Card.Content>
              <Card.Cover
                style={{
              ...
              <Card.Actions>
                <Button mode='contained' textColor='white' theme={{ colors: { primary: 'red' } }} onPress={() => handleDelete(item.bitacora_id)}>
                  Eliminar
                </Button>
              </Card.Actions>
            </Card>
