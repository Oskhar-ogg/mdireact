          ...
          >
            ...
            <Card.Content>
              ...
              <TextInput
                ...
                value={inventarioData.inv_cal_tipo_repuesto}
                onChangeText={(text) => handleInputChange('inv_cal_tipo_repuesto', text)}
              />
              ...
              <ScrollView horizontal>
                <CheckBox
                  title="Original"
                  checked={inventarioData.inv_cal_marca_repuesto === 'Original'}
                  onPress={() => handleInputChange('inv_cal_marca_repuesto', 'Original')}
                />
                <CheckBox
                  title="Alternativo"
                  checked={inventarioData.inv_cal_marca_repuesto === 'Alternativo'}
                  onPress={() => handleInputChange('inv_cal_marca_repuesto', 'Alternativo')}
                />
              </ScrollView>
              <Text style={{ color: 'red' }}>*Obligatorio</Text>
              ...
              <TextInput
                ...
                value={inventarioData.inv_cal_ubicacion}
                onChangeText={(text) => handleInputChange('inv_cal_ubicacion', text)}
              />
              <Text style={{ color: 'red' }}>*Obligatorio</Text>
          ...
          >
            ...
            <Card.Content>
              ...
              <ScrollView horizontal>
                ...
                maxLength={4}
                placeholder="Ej: 9999"
                value={String(inventarioData.inv_cal_cantidad)}
                onChangeText={(text) => handleInputChange('inv_cal_cantidad', text)}
                />
                <Button
                  icon="plus"
